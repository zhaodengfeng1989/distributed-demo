 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://impl.zhaodf.com/", wsdlLocation = "http://localhost:8888/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://impl.zhaodf.com/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://impl.zhaodf.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.zhaodf.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
